...
Environment
The environment built following this article is a cluster compounded of three nodes, 1 master + 2 workers.

OS is CentOS 7.

VMs have been created with VirtualBox 6.1.10.

Host is a MacBook Pro 2020.

Ansible version is 2.9.10.

Kubernetes version is 1.19.0

Flannel is the networking solution.

Sources
The playbooks used to build the cluster are available here: https://bitbucket.org/cmoyamoradas/k8s-cluster/src/master/
...
Either you disable the SSH key host checking, editing the /etc/ansible/ansible.cfg file and uncomment this line

host_key_checking = False
Or you add the host's fingerprint to the known_hosts file by SSHing into the master and workers from the ansible host, this prompts you to save the host's fingerprint to your known_hosts file:
...
Check if the objects have been deleted. Running the following command, the output should be empty:

$ kubectl get secret,sa,role,rolebinding,services,deployments --namespace=kube-system | grep dashboard
Final check, “kubernetes-dashboard” namespace shouldn’t appear running the following command:
